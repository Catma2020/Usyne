...
public class BigBirdModel extends EntityModel<BigBird>
{
    ...
    public static TexturedModelData getTexturedModelData()
	{
		...
		modelPartData.addChild(EntityModelPartNames.NECK, ModelPartBuilder.create().uv(0, 40).cuboid(-6.0f, 0.0f, -20.0f, 12.0f, 6.0f, 14.0f), ModelTransform.pivot(-1.0f, 0.0f, 0.0f));
